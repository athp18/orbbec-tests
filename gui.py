...
class CameraRecordingGUI:
    ...
    def start_recording(self):
        ...
        # Call the start_recording function with the collected parameters
        start_recording(
            base_dir=directory,
            subject_name=subject_name,
            session_name=session_name,
            recording_length=recording_length * 60,  # Convert minutes to seconds
            save_ir=save_ir,
